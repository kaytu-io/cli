class Kaytu < Formula
  ...
  if OS.mac? && Hardware::CPU.arm?
    url "https://github.com/kaytu-io/cli-program/releases/download/v1.8.27/ktucli-macos-arm64"
  ...
  if OS.linux? && Hardware::CPU.arm?
    url "https://github.com/kaytu-io/cli-program/releases/download/v1.8.27/ktucli-linux-arm64"
  ...
  if OS.linux? && Hardware::CPU.intel?
    url "https://github.com/kaytu-io/cli-program/releases/download/v1.8.27/ktucli-linux-amd64"

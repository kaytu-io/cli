...
var UrlNames = map[string]string{
	...
	"get_compliance_api_v1_benchmarks_benchmark_id_policies_policy_id":             "-",
	"post_compliance_api_v1_findings_filters":                                      "-",
	"get_cost_estimator_api_v1_cost_aws":                                           "-",
	"get_cost_estimator_api_v1_cost_azure":                                         "-",
	"get_inventory_api_v2_metadata_resource_collection_resource_collection_id":     "-",
	...
	"post_onboard_api_v2_credential":                                               "-",
	"get_compliance_api_v1_assignments_resource_collection_resource_collection_id": "-",
	"post_onboard_api_v1_connections_aws":                                          "-",

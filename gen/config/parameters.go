...
var ParamModels = map[string]interface{}{
	...
	"GetCostEstimatorAPIV1CostAwsResourceTypeResourceID":    cost_estimator.GetCostEstimatorAPIV1CostAwsResourceTypeResourceIDParams{},
	"GetCostEstimatorAPIV1CostAzureResourceTypeResourceID":  cost_estimator.GetCostEstimatorAPIV1CostAzureResourceTypeResourceIDParams{},
	...
	"GetWorkspaceAPIV1BootstrapWorkspaceNameFinish":         workspace.GetWorkspaceAPIV1BootstrapWorkspaceNameFinishParams{},

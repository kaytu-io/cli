...
// GitlabComKeibiengineKeibiEnginePkgOnboardAPICredential gitlab com keibiengine keibi engine pkg onboard api credential
//
// swagger:model gitlab_com_keibiengine_keibi-engine_pkg_onboard_api.Credential
type GitlabComKeibiengineKeibiEnginePkgOnboardAPICredential struct {
...
// Validate validates this gitlab com keibiengine keibi engine pkg onboard api credential
func (m *GitlabComKeibiengineKeibiEnginePkgOnboardAPICredential) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *GitlabComKeibiengineKeibiEnginePkgOnboardAPICredential) validateConnections(formats strfmt.Registry) error {
...
func (m *GitlabComKeibiengineKeibiEnginePkgOnboardAPICredential) validateConnectorType(formats strfmt.Registry) error {
...
func (m *GitlabComKeibiengineKeibiEnginePkgOnboardAPICredential) validateCredentialType(formats strfmt.Registry) error {
...
func (m *GitlabComKeibiengineKeibiEnginePkgOnboardAPICredential) validateHealthStatus(formats strfmt.Registry) error {
...
// ContextValidate validate this gitlab com keibiengine keibi engine pkg onboard api credential based on the context it is used
func (m *GitlabComKeibiengineKeibiEnginePkgOnboardAPICredential) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *GitlabComKeibiengineKeibiEnginePkgOnboardAPICredential) contextValidateConnections(ctx context.Context, formats strfmt.Registry) error {
...
func (m *GitlabComKeibiengineKeibiEnginePkgOnboardAPICredential) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *GitlabComKeibiengineKeibiEnginePkgOnboardAPICredential) UnmarshalBinary(b []byte) error {
	var res GitlabComKeibiengineKeibiEnginePkgOnboardAPICredential

...
func (o *GetInventoryAPIV2ServicesSummaryServiceNameParams) WriteToRequest(r runtime.ClientRequest, reg strfmt.Registry) error {
	...
	if o.ConnectorID != nil {
		...
		// binding items for connectorId
		joinedConnectorID := o.bindParamConnectorID(reg)

		// query array param connectorId
		if err := r.SetQueryParam("connectorId", joinedConnectorID...); err != nil {
			return err
		}
	}
...
// bindParamGetInventoryAPIV2ServicesSummaryServiceName binds the parameter connector
func (o *GetInventoryAPIV2ServicesSummaryServiceNameParams) bindParamConnector(formats strfmt.Registry) []string {
...
// bindParamGetInventoryAPIV2ServicesSummaryServiceName binds the parameter connectorId
func (o *GetInventoryAPIV2ServicesSummaryServiceNameParams) bindParamConnectorID(formats strfmt.Registry) []string {
	connectorIDIR := o.ConnectorID

	var connectorIDIC []string
	for _, connectorIDIIR := range connectorIDIR { // explode []string

		connectorIDIIV := connectorIDIIR // string as string
		connectorIDIC = append(connectorIDIC, connectorIDIIV)
	}

	// items.CollectionFormat: "csv"
	connectorIDIS := swag.JoinByFormat(connectorIDIC, "csv")

	return connectorIDIS
}

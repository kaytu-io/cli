...
// WithConnectionGroup adds the connectionGroup to the get compliance API v1 insight group params
func (o *GetComplianceAPIV1InsightGroupParams) WithConnectionGroup(connectionGroup []string) *GetComplianceAPIV1InsightGroupParams {
	o.SetConnectionGroup(connectionGroup)
	return o
}

// SetConnectionGroup adds the connectionGroup to the get compliance API v1 insight group params
func (o *GetComplianceAPIV1InsightGroupParams) SetConnectionGroup(connectionGroup []string) {
...
// WithResourceCollection adds the resourceCollection to the get compliance API v1 insight group params
func (o *GetComplianceAPIV1InsightGroupParams) WithResourceCollection(resourceCollection []string) *GetComplianceAPIV1InsightGroupParams {
	o.SetResourceCollection(resourceCollection)
	return o
}

// SetResourceCollection adds the resourceCollection to the get compliance API v1 insight group params
func (o *GetComplianceAPIV1InsightGroupParams) SetResourceCollection(resourceCollection []string) {
...
// bindParamGetComplianceAPIV1InsightGroup binds the parameter connectionGroup
func (o *GetComplianceAPIV1InsightGroupParams) bindParamConnectionGroup(formats strfmt.Registry) []string {
...
// bindParamGetComplianceAPIV1InsightGroup binds the parameter resourceCollection
func (o *GetComplianceAPIV1InsightGroupParams) bindParamResourceCollection(formats strfmt.Registry) []string {

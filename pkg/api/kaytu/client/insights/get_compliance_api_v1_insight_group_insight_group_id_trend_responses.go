...
type GetComplianceAPIV1InsightGroupInsightGroupIDTrendOK struct {
	Payload *models.GithubComKaytuIoKaytuEnginePkgComplianceAPIInsightGroupTrendResponse
}
...
func (o *GetComplianceAPIV1InsightGroupInsightGroupIDTrendOK) GetPayload() *models.GithubComKaytuIoKaytuEnginePkgComplianceAPIInsightGroupTrendResponse {
	return o.Payload
}
...
func (o *GetComplianceAPIV1InsightGroupInsightGroupIDTrendOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.GithubComKaytuIoKaytuEnginePkgComplianceAPIInsightGroupTrendResponse)

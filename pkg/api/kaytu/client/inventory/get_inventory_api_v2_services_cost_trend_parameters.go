...
// WithTag adds the tag to the get inventory API v2 services cost trend params
func (o *GetInventoryAPIV2ServicesCostTrendParams) WithTag(tag *string) *GetInventoryAPIV2ServicesCostTrendParams {
	o.SetTag(tag)
	return o
}

// SetTag adds the tag to the get inventory API v2 services cost trend params
func (o *GetInventoryAPIV2ServicesCostTrendParams) SetTag(tag *string) {
	o.Tag = tag
}

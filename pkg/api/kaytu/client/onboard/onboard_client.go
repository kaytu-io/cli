...
/*
GetOnboardAPIV1Connectors gets connectors
...
func (a *Client) GetOnboardAPIV1Connectors(params *GetOnboardAPIV1ConnectorsParams, opts ...ClientOption) (*GetOnboardAPIV1ConnectorsOK, error) {
	...
	op := &runtime.ClientOperation{
		ID:                 "GetOnboardAPIV1Connectors",
		Method:             "GET",
		PathPattern:        "/onboard/api/v1/connectors",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"https"},
		Params:             params,
	...
	success, ok := result.(*GetOnboardAPIV1ConnectorsOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for GetOnboardAPIV1Connectors: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}

/*
GetOnboardAPIV1ConnectorsConnectorName gets connector
...
func (a *Client) GetOnboardAPIV1ConnectorsConnectorName(params *GetOnboardAPIV1ConnectorsConnectorNameParams, opts ...ClientOption) (*GetOnboardAPIV1ConnectorsConnectorNameOK, error) {
	...
	op := &runtime.ClientOperation{
		ID:                 "GetOnboardAPIV1ConnectorsConnectorName",
		Method:             "GET",
		PathPattern:        "/onboard/api/v1/connectors/{connectorName}",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"https"},
		Params:             params,
	...
	success, ok := result.(*GetOnboardAPIV1ConnectorsConnectorNameOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for GetOnboardAPIV1ConnectorsConnectorName: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
/*
GetOnboardAPIV1Providers gets providers
...
func (a *Client) GetOnboardAPIV1Providers(params *GetOnboardAPIV1ProvidersParams, opts ...ClientOption) (*GetOnboardAPIV1ProvidersOK, error) {
	...
	op := &runtime.ClientOperation{
		ID:                 "GetOnboardAPIV1Providers",
		Method:             "GET",
		PathPattern:        "/onboard/api/v1/providers",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"https"},
		Params:             params,
	...
	success, ok := result.(*GetOnboardAPIV1ProvidersOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for GetOnboardAPIV1Providers: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}

/*
GetOnboardAPIV1ProvidersTypes gets provider types
...
func (a *Client) GetOnboardAPIV1ProvidersTypes(params *GetOnboardAPIV1ProvidersTypesParams, opts ...ClientOption) (*GetOnboardAPIV1ProvidersTypesOK, error) {
	...
	op := &runtime.ClientOperation{
		ID:                 "GetOnboardAPIV1ProvidersTypes",
		Method:             "GET",
		PathPattern:        "/onboard/api/v1/providers/types",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"https"},
		Params:             params,
	...
	success, ok := result.(*GetOnboardAPIV1ProvidersTypesOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for GetOnboardAPIV1ProvidersTypes: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) PostOnboardAPIV1SourceSourceIDDisable(params *PostOnboardAPIV1SourceSourceIDDisableParams, opts ...ClientOption) (*PostOnboardAPIV1SourceSourceIDDisableOK, error) {
	...
	op := &runtime.ClientOperation{
		ID:                 "PostOnboardAPIV1SourceSourceIDDisable",
		Method:             "POST",
		PathPattern:        "/onboard/api/v1/source/{sourceId}/disable",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"https"},
		Params:             params,
	...
	success, ok := result.(*PostOnboardAPIV1SourceSourceIDDisableOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for PostOnboardAPIV1SourceSourceIDDisable: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
...
func (a *Client) PostOnboardAPIV1SourceSourceIDEnable(params *PostOnboardAPIV1SourceSourceIDEnableParams, opts ...ClientOption) (*PostOnboardAPIV1SourceSourceIDEnableOK, error) {
	...
	op := &runtime.ClientOperation{
		ID:                 "PostOnboardAPIV1SourceSourceIDEnable",
		Method:             "POST",
		PathPattern:        "/onboard/api/v1/source/{sourceId}/enable",
		ProducesMediaTypes: []string{"application/json"},
		ConsumesMediaTypes: []string{"application/json"},
		Schemes:            []string{"https"},
		Params:             params,
	...
	success, ok := result.(*PostOnboardAPIV1SourceSourceIDEnableOK)
	if ok {
		return success, nil
	}
	// unexpected success response
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for PostOnboardAPIV1SourceSourceIDEnable: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}

...
type GetInventoryAPIV2MetadataServicesServiceNameOK struct {
	Payload *models.GitlabComKeibiengineKeibiEnginePkgInventoryAPIServiceMetadata
}
...
func (o *GetInventoryAPIV2MetadataServicesServiceNameOK) GetPayload() *models.GitlabComKeibiengineKeibiEnginePkgInventoryAPIServiceMetadata {
	return o.Payload
}
...
func (o *GetInventoryAPIV2MetadataServicesServiceNameOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
	...
	o.Payload = new(models.GitlabComKeibiengineKeibiEnginePkgInventoryAPIServiceMetadata)

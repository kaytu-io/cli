...
var GetScheduleApiV1StacksStackIdInsightsCmd = &cobra.Command{
	Use: "get_schedule_api_v_1_stacks_stack_id_insights",
	RunE: func(cmd *cobra.Command, args []string) error {
		client, auth, err := kaytu.GetKaytuAuthClient(cmd)
		if err != nil {
		...
		resp, err := client.Stack.GetScheduleAPIV1StacksStackIDInsights(stack.NewGetScheduleAPIV1StacksStackIDInsightsParams(), auth)
		if err != nil {
			return fmt.Errorf("[get_schedule_api_v_1_stacks_stack_id_insights] : %v", err)
		}

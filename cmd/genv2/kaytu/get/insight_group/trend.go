...
var TrendCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		if err != nil {
			return fmt.Errorf("[GetComplianceAPIV1InsightGroupInsightGroupIDTrend] : %v", err)
		}

		err = pkg.PrintOutput(cmd, "GetComplianceAPIV1InsightGroupInsightGroupIDTrend", resp.GetPayload())
		if err != nil {
			return fmt.Errorf("[GetComplianceAPIV1InsightGroupInsightGroupIDTrend] : %v", err)
		}
...
func init() {
	...
	TrendCmd.Flags().String("insight-group-id", "", "Insight Group ID")

	TrendCmd.MarkFlagRequired("insight-group-id")

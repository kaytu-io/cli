...
var GetOnboardApiV1ConnectionsCountCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		req.SetType(&models.GitlabComKeibiengineKeibiEnginePkgOnboardAPIConnectionCountRequest{
			...
			State:      models.GitlabComKeibiengineKeibiEnginePkgOnboardAPIConnectionLifecycleState(flags.ReadStringFlag(cmd, "State")),
		})
...
var PostOnboardApiV1ConnectionsConnectionIdStateCmd = &cobra.Command{
	Use: "connections-connection-id-state",
	RunE: func(cmd *cobra.Command, args []string) error {
		client, auth, err := kaytu.GetKaytuAuthClient(cmd)
		if err != nil {
		...
		req.SetRequest(&models.GitlabComKeibiengineKeibiEnginePkgOnboardAPIChangeConnectionLifecycleStateRequest{
			State: models.GitlabComKeibiengineKeibiEnginePkgOnboardAPIConnectionLifecycleState(flags.ReadStringFlag(cmd, "State")),
		})

...
var PostOnboardApiV1CredentialCredentialIdDisableCmd = &cobra.Command{
	Use: "credentialCredentialIdDisable",
	RunE: func(cmd *cobra.Command, args []string) error {
		client, auth, err := kaytu.GetKaytuAuthClient(cmd)
		if err != nil {
		...
		_, err = client.Onboard.PostOnboardAPIV1CredentialCredentialIDDisable(onboard.NewPostOnboardAPIV1CredentialCredentialIDDisableParams(), auth)
		if err != nil {
			return fmt.Errorf("[post_onboard_api_v_1_credential_credential_id_disable] : %v", err)
		}
...
var PostOnboardApiV1SourceSourceIdDisableCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		_, err = client.Onboard.PostOnboardAPIV1SourceSourceIDDisable(onboard.NewPostOnboardAPIV1SourceSourceIDDisableParams(), auth)
		if err != nil {
			return fmt.Errorf("[post_onboard_api_v_1_source_source_id_disable] : %v", err)
		}
...
var GetOnboardApiV1CredentialCredentialIdHealthcheckCmd = &cobra.Command{
	Use: "credentialCredentialIdHealthcheck",
	RunE: func(cmd *cobra.Command, args []string) error {
		client, auth, err := kaytu.GetKaytuAuthClient(cmd)
		if err != nil {
		...
		_, err = client.Onboard.GetOnboardAPIV1CredentialCredentialIDHealthcheck(onboard.NewGetOnboardAPIV1CredentialCredentialIDHealthcheckParams(), auth)
		if err != nil {
			return fmt.Errorf("[get_onboard_api_v_1_credential_credential_id_healthcheck] : %v", err)
		}
...
var PostOnboardApiV1CredentialCredentialIdEnableCmd = &cobra.Command{
	Use: "credentialCredentialIdEnable",
	RunE: func(cmd *cobra.Command, args []string) error {
		client, auth, err := kaytu.GetKaytuAuthClient(cmd)
		if err != nil {
		...
		_, err = client.Onboard.PostOnboardAPIV1CredentialCredentialIDEnable(onboard.NewPostOnboardAPIV1CredentialCredentialIDEnableParams(), auth)
		if err != nil {
			return fmt.Errorf("[post_onboard_api_v_1_credential_credential_id_enable] : %v", err)
		}
...
var PutOnboardApiV1CredentialCredentialIdCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		_, err = client.Onboard.PutOnboardAPIV1CredentialCredentialID(onboard.NewPutOnboardAPIV1CredentialCredentialIDParams(), auth)
		if err != nil {
			return fmt.Errorf("[put_onboard_api_v_1_credential_credential_id] : %v", err)
		}
...
var PostOnboardApiV1CredentialCredentialIdAutoonboardCmd = &cobra.Command{
	Use: "credentialCredentialIdAutoonboard",
	RunE: func(cmd *cobra.Command, args []string) error {
		client, auth, err := kaytu.GetKaytuAuthClient(cmd)
		if err != nil {
...
var DeleteOnboardApiV1SourceSourceIdCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		_, err = client.Onboard.DeleteOnboardAPIV1SourceSourceID(onboard.NewDeleteOnboardAPIV1SourceSourceIDParams(), auth)
		if err != nil {
			return fmt.Errorf("[delete_onboard_api_v_1_source_source_id] : %v", err)
		}
...
var PostOnboardApiV1SourceSourceIdEnableCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		_, err = client.Onboard.PostOnboardAPIV1SourceSourceIDEnable(onboard.NewPostOnboardAPIV1SourceSourceIDEnableParams(), auth)
		if err != nil {
			return fmt.Errorf("[post_onboard_api_v_1_source_source_id_enable] : %v", err)
		}
...
var PutOnboardApiV1SourceSourceIdCredentialsCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		_, err = client.Onboard.PutOnboardAPIV1SourceSourceIDCredentials(onboard.NewPutOnboardAPIV1SourceSourceIDCredentialsParams(), auth)
		if err != nil {
			return fmt.Errorf("[put_onboard_api_v_1_source_source_id_credentials] : %v", err)
		}
...
var DeleteOnboardApiV1CredentialCredentialIdCmd = &cobra.Command{
	...
	RunE: func(cmd *cobra.Command, args []string) error {
		...
		_, err = client.Onboard.DeleteOnboardAPIV1CredentialCredentialID(onboard.NewDeleteOnboardAPIV1CredentialCredentialIDParams(), auth)
		if err != nil {
			return fmt.Errorf("[delete_onboard_api_v_1_credential_credential_id] : %v", err)
		}

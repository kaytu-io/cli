...
GetInventoryApiV2ServicesCompositionKeyCmd.Flags().StringArray("connection-id", nil, "")
GetInventoryApiV2ServicesCompositionKeyCmd.Flags().StringArray("connector", nil, "")
GetInventoryApiV2ServicesCompositionKeyCmd.Flags().String("end-time", "", "")
GetInventoryApiV2ServicesCompositionKeyCmd.Flags().String("key", "", "")
GetInventoryApiV2ServicesCompositionKeyCmd.Flags().String("start-time", "", "")
GetInventoryApiV2ServicesCompositionKeyCmd.Flags().Int64("top", 0, "")
...
GetInventoryApiV2ServicesCostTrendCmd.Flags().String("tag", "", "")

...
func init() {
	...
	GetInventoryApiV2ServicesSummaryCmd.Flags().String("connection-id", "", "")
	GetInventoryApiV2ServicesSummaryCmd.Flags().String("connector", "", "")
	GetInventoryApiV2ServicesSummaryCmd.Flags().String("end-time", "", "")
	GetInventoryApiV2ServicesSummaryCmd.Flags().Int64("min-spent", 0, "")

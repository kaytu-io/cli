...
func init() {
	...
	PutScheduleApiV1ComplianceTriggerCmd.Flags().String("benchmark-id", "", "")
	PutScheduleApiV1ComplianceTriggerCmd.Flags().String("connection-id", "", "")
	PutScheduleApiV1ComplianceTriggerCmd.Flags().StringArray("resource-i-ds", nil, "")

...
func init() {
	...
	GetScheduleApiV1BenchmarkEvaluationsCmd.MarkFlagRequired("connector")
	...
	PostScheduleApiV1DescribeResourceCmd.MarkFlagRequired("additional-fields")
	PostScheduleApiV1DescribeResourceCmd.Flags().String("provider", "", "")
	PostScheduleApiV1DescribeResourceCmd.MarkFlagRequired("provider")
